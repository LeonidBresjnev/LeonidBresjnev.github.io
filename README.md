...
1. [Bibliografi](https://leonidbresjnev.github.io/bibliografi/) ([GitHub](https://github.com/LeonidBresjnev/bibliografi))
   - BibTeX
   - JavaScript/React
2. [Rubik Cube Solver](https://leonidbresjnev.github.io/rubiks-cube/) ([GitHub](https://github.com/LeonidBresjnev/rubiks-cube))
   - JavaScript/React
3. [Bayesian information borrowing](https://leonidbresjnev.github.io/funwithwasm/) ([GitHub](https://github.com/LeonidBresjnev/funwithwasm))
   - Bayesian modelling
   - Kotlin/WASM
   - Jetpack Compose
...
6. [myMediaPlayer](https://github.com/LeonidBresjnev/myMediaPlayer)
   ...
   - Android Auto
   - Signal processing
7. [filterexplorer](https://github.com/LeonidBresjnev/filterexplorer.git)
   - Kotlin
   - Jetpack Compose
   - Signal processing
<!-- PROJECTS:END -->
